                ...
                <div className={`col__content col__content--${project.id}`}>
                  ...
                  <div className="col__content-wrap">
                    ...
                    {(() => {
                      ...
                      return (
                        <a
                          className={`slide-link ${isGitHub ? 'slide-link--github' : 'slide-link--live'}`}
                          href={project.url}
                          target="_blank"
                          rel="noreferrer"
                        >
                          <div className="slide-link__circ" />
                          <div className="slide-link__inner">
                            {isGitHub ? (
                              <svg className="slide-link__icon" viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
                              ...
                              <svg className="slide-link__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="18" height="18">
                                <path d="M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6M15 3h6v6M10 14L21 3"/>
                              </svg>
                            )}
                            <span className="slide-link__label">{isGitHub ? 'Source' : 'Live'}</span>
                          </div>
                        </a>
                      );
                    })()}
